...
async function downloadPNG() {
  ...
  const GRADIENT_FIX_CSS = `
    ...
    /* html2canvas 1.4.1 does NOT render the backgrounds/borders of CSS Grid
       items, which made the dark prayer panels vanish and the shrine bleed
       through behind the text. Converting the two-column grid to flexbox (which
       html2canvas renders correctly) restores the opaque panels. */
    #poster .content-grid { display:flex !important; flex-direction:row !important; gap:12px !important; align-items:flex-start !important; }
    #poster .col-panel { flex:1 1 0 !important; min-width:0 !important; }
  `;
